...
\begin{itemize}
  ...
  \item \textbf{Disco:} \texttt{SSD NVMe 1 TB}.
...
La compilación y ejecución está automatizada con \texttt{Makefile}. Los tiempos se midieron en nanosegundos $(ns)$ con \texttt{<chrono>} \parencite{cppreference_chrono} y uso de memoria en kilobytes (KB) mediante el pico máximo de memoria heap asignada por cada algoritmo. \parencite{so_memory_tracking_new_delete}