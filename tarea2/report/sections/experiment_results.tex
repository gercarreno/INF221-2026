...
es \emph{pseudopolinomial}: polinomial en los valores enteros pero exponencial en binario. Para instancias con $M$ y $E$ acotados, este enfoque produce la solución óptima de forma eficiente, a diferencia de la fuerza bruta \ref{fig:complejidad_empirica}.
