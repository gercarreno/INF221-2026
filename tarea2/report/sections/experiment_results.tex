...
\textit{Greedy ratio} no presenta una correlación relevante: N animes ($r=0{,}34$), total de capítulos ($r=0{,}31$), minutos disponibles ($r=-0{,}10$) y energía disponible ($r=-0{,}31$), todas con $|r|\leq 0{,}35$. En otras palabras, ni el tamaño de la instancia ni la cantidad de recursos disponibles determinan por sí solos qué tan cerca del óptimo queda la solución.

\textit{Greedy max} sí muestra una correlación positiva y significativa con la calidad: N animes ($r=0{,}46$, $p<0{,}05$) y total de capítulos ($r=0{,}42$, $p<0{,}05$). Es decir, de las cuatro variables, son la cantidad de animes y de capítulos las que realmente influyen en qué tan buena es la solución, mientras que minutos disponibles ($r=0{,}06$) y energía disponible ($r=0{,}30$) no tienen un impacto tan notorio. La razón está en la lógica de la heurística. 

Ninguna variable de entrada es determinante para greedy ratio, mientras que para greedy max la calidad depende principalmente del número de animes y capítulos disponibles, y no de la cantidad de recursos (tiempo o energía).
...
\begin{itemize}
    ...
    \item \textbf{Greedy ratio}: Ofrece el mejor equilibrio, con una calidad muy cercana al óptimo (alrededor del 90-100\%) pero con órdenes de magnitud menor que DP respecto del tiempo de ejecución. Si nuestro problema nos permite tolerar una pequeña desviación respecto del óptimo, esta heurística es la correcta.
